...
class Customer_J05082 implements Comparable<Customer_J05082> {
    private String code, name, gender, birth, address;

    public  Customer_J05082 (int stt, String name, String gender, String birth, String address) {
        this.code = "KH";
        if(stt < 10) {
            this.code += "00" + stt;
        }
    ...
    @Override
    public int compareTo(Customer_J05082 a) {
...
public class J05082_Danh_sach_khach_hang {
    static String nameNormalization(String s) {
        String ans = "";
    ...
    static String birthNomalization(String s) {
        String ans = "";
        String[] tmp = s.split("/");
        for(int i = 0; i < 3; i++) {
            if(i < 2) {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Customer_J05082> a = new ArrayList<>();
        for(int i = 0; i < n; i++) {
            ...
            birth = birthNomalization(birth);
            a.add(new Customer_J05082(i + 1, name, gender, birth, address));
        }
        Collections.sort(a);
        for(Customer_J05082 i: a) {
