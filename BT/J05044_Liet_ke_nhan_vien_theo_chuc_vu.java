...
class Employee_J05044 {
    ...
    public Employee_J05044(int stt, String name, String position, int luongCB, int ngayCong) {
        this.code = "NV";
        if(stt < 10) {
            this.code += "0" + stt;
        }
...
public class J05044_Liet_ke_nhan_vien_theo_chuc_vu {
    public static void main(String[] args) {
        ...
        ArrayList<Employee_J05044> a = new ArrayList<>();
        for(int i = 0; i < n; i++) {
            String name = scanner.nextLine();
            String position = scanner.nextLine();
            int luongCB = Integer.parseInt(scanner.nextLine());
            int ngayCong = Integer.parseInt(scanner.nextLine());
            a.add(new Employee_J05044(i + 1, name, position, luongCB, ngayCong));
        }
        String position = scanner.nextLine();
        for(Employee_J05044 i: a) {
