...
class Employee_J05077 {
    private String code, name, room;
    private long luongCB, ngayCong, heSo, tong;
    public Employee_J05077(String code, String room, String name, long luongCB, long ngayCong) {
        this.code = code;
        this.room = room;
        this.name = name;
    ...
    public String toString() {
        return this.code + " " + this.name + " " + this.room + " " + this.tong;
    }
}
public class J05077_Tinh_luong {
    public static void main(String[] args) {
        ...
        ArrayList<Employee_J05077> a = new ArrayList<>();
        for(int i = 0; i < q; i++) {
            ...
            a.add(new Employee_J05077(code, room, name, luongCB, ngayCong));
        }
        for(Employee_J05077 i: a) {
