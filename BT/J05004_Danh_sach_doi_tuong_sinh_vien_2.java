...
class Student_J05004 {
    private String code, name, birth, lop;
    private double gpa;

    public Student_J05004() {
        this.code = "";
        this.name = "";
        this.birth = "";
        this.lop = "";
    ...
    public Student_J05004(int stt, String name, String lop, String birth, double gpa) {
        this.code = "B20DCCN";
...
public class J05004_Danh_sach_doi_tuong_sinh_vien_2 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Student_J05004> a = new ArrayList<>();
        for(int i = 0; i < n; i++) {
            ...
            a.add(new Student_J05004(i + 1, name, lop, birth, gpa));
        }
        for(Student_J05004 i: a) {
