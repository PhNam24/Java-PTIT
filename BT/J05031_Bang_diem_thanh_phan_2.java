...
class Student_J05031 implements Comparable<Student_J05031>{
    private String code, name, lop;
    private double p1, p2, p3;

    public Student_J05031() {
        this.code = null;
        this.name = null;
        this.lop = null;
        this.p1 = 0;
    ...
    public Student_J05031(String code, String name, String lop, double p1, double p2, double p3) {
        this.code = code;
        this.name = name;
        this.lop = lop;
        this.p1 = p1;
    ...
    @Override
    public int compareTo(Student_J05031 a) {
...
public class J05031_Bang_diem_thanh_phan_2 {
    public static void main(String[] args) {
        ...
        ArrayList<Student_J05031> a = new ArrayList<>();
        for(int i = 0 ;i < n; i++) {
            ...
            a.add(new Student_J05031(code, name, lop, p1, p2, p3));
        }
        Collections.sort(a);
        int stt = 1;
        for(Student_J05031 i: a) {
