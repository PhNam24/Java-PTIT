...
class Employee_J05041 implements Comparable<Employee_J05041> {
    ...
    public Employee_J05041(int stt, String name, int luongCB, int ngayCong, String position) {
        this.code = "NV";
        if(stt < 10) {
            this.code += "0" + stt;
        }
    ...
    @Override
    public int compareTo(Employee_J05041 a) {
...
public class J05041_Sap_xep_bang_tinh_cong {
    public static void main(String[] args) {
        ...
        ArrayList<Employee_J05041> a = new ArrayList<>();
        for(int i = 0; i < n; i++) {
            String name = scanner.nextLine();
            int luongCB = Integer.parseInt(scanner.nextLine());
            int ngayCong = Integer.parseInt(scanner.nextLine());
            String position = scanner.nextLine();
            a.add(new Employee_J05041(i + 1, name, luongCB, ngayCong, position));
        }
        Collections.sort(a);
        for(Employee_J05041 i: a) {
