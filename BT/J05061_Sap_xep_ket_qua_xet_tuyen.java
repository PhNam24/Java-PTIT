...
import java.util.*;
class Employee_J05061 implements Comparable<Employee_J05061> {
    private String code, name, rank;
    private int age;
    private double lt, th, extra, sum;

    public Employee_J05061() {
        this.code = null;
        this.name = null;
        this.age = 0;
        this.lt = 0;
    ...
    public Employee_J05061(int stt, String name, int age, double lt, double th) {
        this.code = "PH";
    ...
    @Override
    public int compareTo(Employee_J05061 a) {
        this.sum = Math.round(this.sum);
...
public class J05061_Sap_xep_ket_qua_xet_tuyen {
    public static void main(String[] args) {
        ...
        ArrayList<Employee_J05061> a = new ArrayList<>();
        for(int i = 0; i < n; i++) {
            ...
            a.add(new Employee_J05061(i + 1, name, age, lt, th));
        }
        Collections.sort(a);
        for(Employee_J05061 i: a) {
